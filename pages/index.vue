  ...
  <div class="container mx-auto ui-container">
    <div class="mx-8 my-24">
      <svg
        ...
        class="w-120px h-120px md:w-150px md:h-150px lg:w-180px lg:h-180px"
      >
        <path
        ...
        <defs>
          ...
          <image
            ...
            width="720"
            height="720"
            xlink:href="https://cdn.wuyuan.dev/sitelogo.png"
          ></image>
        </defs>
      </svg>
      <div
...
1      >
      ...
      <mdui-card variant="filled" style="width: 100%; padding: 1rem">
        <img
          src="https://gh.190823.xyz/https://raw.githubusercontent.com/sunwuyuan/sunwuyuan/output/github-contribution-grid-snake-dark.svg"
        />
        <div
        ...
        >
          ...
          <p class="text-base" style="margin-left: 0.2rem">
        ...
        >
          <mdui-list>
            <mdui-list-subheader
              >Personal Introduction / 个人介绍</mdui-list-subheader
            >

            <mdui-collapse>
              <mdui-collapse-item value="item-1">
                <mdui-list-item rounded slot="header" icon="school"
                  ><mdui-icon
                    slot="end-icon"
                    name="keyboard_arrow_down"

                  ></mdui-icon
                  ><b>学校</b><span slot="description">高中了</span></mdui-list-item
                >
                <div style="margin-left: 2.5rem">
                  <mdui-list-item
                    ...
                    description="或许以后公开?"
                    icon="school"
                    ><b>某不知名小学</b></mdui-list-item
                  >
                  <mdui-list-item
                    rounded
                    description="或许以后曝光?"
                    icon="school"
                    ><b>某不知名初中</b></mdui-list-item
                  >
                </div>
              </mdui-collapse-item>
              <mdui-collapse-item value="item-2">
                <mdui-list-item rounded slot="header" icon="favorite"
                  ><mdui-icon
                    slot="end-icon"
                    name="keyboard_arrow_down"
                  ></mdui-icon
                  ><b>技能&amp;特长</b><span slot="description">几乎啥都不会</span></mdui-list-item
                >
                <div style="margin-left: 2.5rem">
                  <mdui-list-item
                    rounded
        ...
        >
          <mdui-list>
            ...
            <mdui-collapse class="example-value">
              <mdui-collapse-item value="item-1">
                <mdui-list-item rounded slot="header" icon="movie"
                  ><mdui-icon
                    slot="end-icon"
                    name="keyboard_arrow_down"
                  ></mdui-icon
                  ><b>ZeroCat社区</b><span slot="description"
                    >开源Scratch社区</span
                  ></mdui-list-item
                >
                <div style="margin-left: 2.5rem">
        ...
        >
          <mdui-list>
            ...
            >
            <b>厚浪云</b><span slot="description"
                >长江后浪推前浪 浮世新人换旧人 本人2024-至今</span
              >
            </mdui-list-item>
            ...
            <mdui-list-item
              ...
              <span slot="description"
                >有道小图灵上的Scratch工作室 本人2021-至今</span
              >
            </mdui-list-item>
              ...
              <mdui-collapse-item value="item-1">
                <mdui-list-item rounded slot="header" icon="history"
                  ><mdui-icon
                    ...
                    name="keyboard_arrow_down"
                  ></mdui-icon
                  >已退出<span slot="description">历史</span></mdui-list-item
                >
                <div style="margin-left: 2.5rem">
                  <mdui-list-item rounded>
                    <b>蜜蜂云</b><span slot="description">不好评价 本人2024-2024</span>
                  </mdui-list-item>
                </div>
              </mdui-collapse-item>
            </mdui-collapse>
        ...
        >
          <mdui-list>
            <mdui-list-subheader
              >Social Information / 社交信息</mdui-list-subheader
            >
            ...
            <mdui-list-item
              ...
              >Github SunWuyuan</mdui-list-item
            >
            <mdui-list-item
              rounded
              description="群聊"
              icon="people"
              href="https://qm.qq.com/q/q4Uw6NSWIg"
              target="_blank"
              end-icon="open_in_new"
              >QQ群聊 悟元喵喵喵</mdui-list-item
            >
            <mdui-collapse>
              <mdui-collapse-item value="item-1">
                ...
                <div style="margin-left: 2.5rem">
                  <mdui-list-item
                    ...
                    description="@sunwuyuan"
                    icon="people"
                    href="https://www.youtube.com/@sunwuyuan"
                    >YouTube</mdui-list-item
                  >
                </div>
              </mdui-collapse-item>
            </mdui-collapse>
