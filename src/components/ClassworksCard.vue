<template>
  <mdui-card variant="filled" class="zerocat-card" href="https://cs.houlangs.com" target="_blank">
    <!-- Header Section -->
    <div class="card-header">
      <img
        src="@/assets/cslogo.svg"
        alt="ZeroCat Logo"
        class="zerocat-logo"
      />
      <div class="header-text">
        <h2 class="title">Classworks 作业板</h2>
        <p class="subtitle">适用于班级大屏的作业板小工具</p>
      </div>
    </div>
    ...
    <div class="card-content">
      <p class="description">
        Classworks 是一个适用于班级大屏的作业板小工具，在班级一体机上记录、显示与同步作业信息。
      </p>
